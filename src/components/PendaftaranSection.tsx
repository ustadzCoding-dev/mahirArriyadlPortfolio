          ...
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-3">
              <a
                ...
                className="inline-flex items-center justify-center gap-3 bg-gradient-gold text-accent-foreground font-display font-bold px-10 py-4 rounded-lg text-lg shadow-gold hover:opacity-90 transition-opacity opacity-70 pointer-events-none"
              >
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-3 bg-gradient-emerald text-primary-foreground font-display font-bold px-10 py-4 rounded-lg text-lg shadow-emerald hover:opacity-90 transition-opacity"
              >
